...
import CreateBranchForm from "../form/CreateBranchForm";
...
const BranchDataTable = ({ columns, data, searchColumn, addBranchHandler, isFetchingData }) => {
        ...
        <div className="flex gap-2">
          <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
            ...
            <DialogContent className="overflow-y-scroll max-h-[90vh]">
              ...
              <CreateBranchForm submitHandler={handleAddBranch} />
            </DialogContent>
          </Dialog>
